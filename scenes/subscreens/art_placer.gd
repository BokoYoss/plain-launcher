...
func _ready():
	...
	CURSOR.position = Vector2(Global.window_width * Settings.get_setting(Settings.CFG_VISUAL_ART_POSITION_X), Global.window_height * Settings.get_setting(Settings.CFG_VISUAL_ART_POSITION_Y))
