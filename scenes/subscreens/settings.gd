...
func show_visual_settings():
	...
	var visual_settings = ["Change size", "Title orientation", "Title size", "Main title: " + str(Settings.get_setting(Settings.CFG_SYSTEM_TITLE)), "Cover size", "Cover position", "Cover border", "Cover opacity", "Drop shadow", "System Art: " + str(Settings.get_setting(Settings.CFG_VISUAL_BUILTIN_SYSTEM_ART)), "System borders: " + str(Settings.get_setting(Settings.CFG_VISUAL_SYSTEM_BORDER)), "Left margin", "Top margin", "Text cutoff: " + LOREM, "Letter outlines", "Change font", "Change background color", "Change foreground color"]
